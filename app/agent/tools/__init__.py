...
_DESKTOP_CONTROL_SCHEMA: dict[str, Any] = {
...
def get_tools_schema() -> list[dict[str, Any]]:
    schemas = list(_ALWAYS_SCHEMAS)
    if "shell_tool" in TOOLS_REGISTRY:
        schemas.append(_SHELL_SCHEMA)
    if "desktop_control_tool" in TOOLS_REGISTRY:
        schemas.append(_DESKTOP_CONTROL_SCHEMA)
    return schemas
